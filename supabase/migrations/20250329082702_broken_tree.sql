/*
  # Add update_coupon_usage function

  1. New Functions
    - `update_coupon_usage`
      - Parameters:
        - p_coupon_id (uuid): The ID of the coupon to update
        - p_increment (boolean): Whether to increment (true) or decrement (false) the usage count
      - Returns: void
  ...
  2. Security
    ...
    - Validates coupon exists before updating
    - Checks max_uses limit before incrementing
*/
